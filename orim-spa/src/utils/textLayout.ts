...
export function estimateTextBlockHeight(
  ...
  return estimateTextLineCount(text, availableWidth, fontSize) * fontSize * lineHeightFactor;
}
...
export function doesTextFit(
  ...
  return estimateTextBlockHeight(text, availableWidth, fontSize) <= availableHeight;
}
