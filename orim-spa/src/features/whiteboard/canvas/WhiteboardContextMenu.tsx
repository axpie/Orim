...
export function WhiteboardContextMenu({
  ...
  const selectionMenuItems = [
    ...
    <ActionMenuItem
      ...
      onMouseEnter={closeArrangeMenu}
    />,
    <Divider key="selection-divider-primary" />,
    ...(canInlineEditSelection
      ? [
        <ActionMenuItem
          key="edit-text"
    ...
    <ActionMenuItem
      ...
      onMouseEnter={closeArrangeMenu}
    />,
    <Divider key="selection-divider-secondary" />,
    <ActionMenuItem
      key="delete"
  ...
  return (
    <>
      ...
      >
        {hasSelection ? selectionMenuItems : emptySelectionMenuItems}
      </Menu>
