import React, { type PointerEventHandler, type ReactNode } from 'react';
...
import { resolveFrameColors } from '../shapes/frameStyle';
...
export const PropertiesPanel = React.memo(function PropertiesPanel({
  ...
  return (
    <AuxiliaryPanelShell
      title={t('properties.title', 'Eigenschaften')}
      onClose={onClose}
      mobile={mobile}
      draggable={draggable}
      ...
      <Box sx={{ flex: 1, overflow: 'auto' }}>
        {!el ? (
          ...
          <Box sx={{ p: 2, display: 'flex', flexDirection: 'column', gap: 2 }}>
            ...
            >
              <PropertiesSection title={el.$type === 'arrow' ? t('properties.position') : t('properties.positionAndRotation')}>
              ...
              {el.$type === 'shape' && (() => {
                ...
                return (
                  <>
                    ...
                    <PropertiesSection title={t('properties.fill')}>
                      <ColorInputField
                    ...
                    <PropertiesSection title={t('properties.outline')}>
                      <ColorInputField
              ...
              {el.$type === 'frame' && (() => {
                ...
                const frameColors = resolveFrameColors(frame, boardDefaults);
                return (
                  <>
                    <PropertiesSection title={t('properties.text')}>
                      <TextField
                      ...
                      <ColorInputField
                        label={t('properties.color')}
                        value={frame.labelColor ?? contrastingTextColor(frameColors.headerFill)}
                        onChange={(value) => update(el.id, { labelColor: value })}
                      />
                      <AlignmentControls
                        horizontal={frame.labelHorizontalAlignment ?? HorizontalLabelAlignment.Left}
                        vertical={frame.labelVerticalAlignment ?? VerticalLabelAlignment.Middle}
                        horizontalLabel={t('properties.horizontal')}
                        verticalLabel={t('properties.frameHeaderVertical')}
                        onHorizontalChange={(value) => update(el.id, { labelHorizontalAlignment: value })}
                        onVerticalChange={(value) => update(el.id, { labelVerticalAlignment: value })}
                      />
                      <TextStyleControls
              ...
              {el.$type === 'arrow' && (() => {
                ...
                return (
                  <>
                    ...
                    <PropertiesSection title={t('properties.arrow')}>
                      <TextField
                        select
