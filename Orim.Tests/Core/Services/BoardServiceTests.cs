...
public class BoardServiceTests
{
    ...
    public async Task CreateBoardAsync_ValidInput_CreatesBoard()
    {
        ...
        Assert.Equal(Board.DefaultEnabledIconGroups, board.EnabledIconGroups);
    ...
    [Fact]
    public async Task CreateBoardFromImportAsync_CopiesEnabledIconGroups()
    {
        var imported = new Board
        {
            EnabledIconGroups = ["privacy", "travel"]
        };

        var board = await _sut.CreateBoardFromImportAsync(imported, "Import", Guid.NewGuid(), "owner");

        Assert.Equal(["privacy", "travel"], board.EnabledIconGroups);
    }

    [Fact]
    public async Task CreateBoardFromImportAsync_LegacyIconGroups_DefaultToCurrentCategorySet()
    {
        var imported = new Board
        {
            EnabledIconGroups = ["security", "analytics"]
        };
    ...
    [Fact]
    public void RestoreSnapshot_RestoresEnabledIconGroups()
    {
        var board = new Board
        {
            Title = "Original",
        ...
        board.EnabledIconGroups = ["ui-actions"];
    ...
    public void ReplaceBoardContent_CopiesProperties()
    {
        ...
        var imported = new Board
        {
            ...
            EnabledIconGroups = ["communicate", "ui-actions"],
            CustomColors = ["#FFF"],
            RecentColors = ["#000"],
        ...
        Assert.Equal(["communicate", "ui-actions"], target.EnabledIconGroups);
