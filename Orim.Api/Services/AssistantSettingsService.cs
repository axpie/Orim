...
{
    private static readonly AssistantSettingsSnapshot EmptySnapshot = new(
        IsEnabled: false,
    ...
    public AssistantSettingsService(IServiceScopeFactory scopeFactory, ILogger<AssistantSettingsService> logger)
    {
    ...
    private void LoadPersistedSettings()
    {
        ...
        {
            _logger.LogWarning(ex, "Failed to load persisted assistant settings from database. Using empty defaults.");
        }
    }
